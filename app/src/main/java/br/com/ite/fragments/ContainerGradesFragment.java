 ...
 */
public class ContainerGradesFragment extends Fragment implements Serializable, OnLoginCallback {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View fragment = inflater.inflate(R.layout.container_fragment, parent, false);
        checkLogin();
    ...
    private void checkLogin() {
        if (!UserStorage.isLogged(getContext())) {
            ...
            getFragmentManager().beginTransaction()
                    .add(R.id.container, loginFragment, "LOGIN_FRAGMENT")
